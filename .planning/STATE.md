...
| 260621-c9m | VIS-66 [GH#215] Consolidate to one community page — folded `/community` "Community Hub" into the homepage (canonical), added a `/community` → `/` 301, repointed ~23 legacy newsletter/digest redirects off `/community` to avoid chains, and fixed nav/Features/HomeFAQ/sitemap links. tsc clean (source); no `/community` refs left. | 2026-06-21 | 6d6046a | [260621-c9m-vis-66-consolidate-community-page](./quick/260621-c9m-vis-66-consolidate-community-page/) |
| 260622-cw5 | VIS-57 (GH#206) — gate "Book a Session" to active mentees on mentor profile (disabled+tooltip for non-mentees), block booking page + 403 server enforcement (active mentorship_session required), and email mentor on booking (confirmed + pending approval). 3 commits, tsc --noEmit clean. | 2026-06-22 | 31af587 | [260622-cw5-vis-57-gate-book-session](./quick/260622-cw5-vis-57-gate-book-session/) |
...
Last session: 2026-06-01T10:10:20.278Z
