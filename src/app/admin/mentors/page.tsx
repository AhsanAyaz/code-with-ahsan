...
export default function AllMentorsPage() {
  ...
  useEffect(() => {
    const fetchMentorshipData = async () => {
      ...
      try {
        const response = await fetch("/api/mentorship/admin/matches?role=mentor");
        if (response.ok) {
  ...
  useEffect(() => {
    const fetchProfiles = async () => {
      try {
        const response = await fetch("/api/mentorship/admin/profiles?role=mentor");
        if (response.ok) {
          const data = await response.json();
            ...
            <div className="form-control mb-4">
              ...
              <select
                ...
                onChange={(e) =>
                  setFilters((prev) => ({
                    ...prev,
                    mentees: e.target.value as typeof filters.mentees,
                  }))
                }
              >
            ...
            <div className="form-control mb-4">
              ...
              <select
                ...
                onChange={(e) =>
                  setFilters((prev) => ({
                    ...prev,
                    rating: e.target.value as typeof filters.rating,
                  }))
                }
              >
                <option value="all">All</option>
