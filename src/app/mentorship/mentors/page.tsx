    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-base-content/70 max-w-2xl mx-auto">
          Meet the amazing professionals who volunteer their time to guide and support others in their career journeys. 
          These mentors have opted to be recognized for their contributions to our community.
        </p>
      </div>
      ...
      <div className="card bg-gradient-to-r from-primary to-secondary text-primary-content">
        <div className="card-body text-center">
          <h3 className="card-title justify-center text-2xl">Want to become a mentor?</h3>
          <p className="opacity-90">Share your expertise and make a difference in someone's career</p>
          <div className="card-actions justify-center mt-4">
            <Link href="/mentorship" className="btn btn-ghost bg-white/20 hover:bg-white/30">
              Get Started
            </Link>
          </div>
        </div>
