...
export default function DashboardLayout({
    ...
    const fetchMatchDetails = async () => {
      ...
      try {
        const response = await fetch(
          `/api/mentorship/dashboard/${matchId}?uid=${user.uid}`,
        );
        if (response.ok) {
  ...
  const basePath = `/mentorship/dashboard/${matchId}`;
  const getTabClass = (segment: string) => {
  ...
  return (
    <DashboardContext.Provider
      value={{
        ...
        currentUserId,
        isMentor: currentIsMentor ?? false,
      }}
    >
      <div className="space-y-6">
        ...
        <div role="tablist" className="tabs tabs-boxed bg-base-200 p-1">
          ...
          <Link
            ...
            role="tab"
            className={getTabClass("learning-hub")}
          >
            📚 Learning Hub
          </Link>
        </div>
            ...
            <div className="modal-box max-w-4xl">
              ...
              <div className="modal-action">
                <a
                  ...
                  download={`mentorship-announcement-${matchId}.png`}
