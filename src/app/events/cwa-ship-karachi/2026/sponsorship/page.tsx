import { SPONSORSHIP_FEATURES, SPONSOR_STATS, EVENT } from "../constants";
    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col gap-10">
      <section className="text-center max-w-5xl mx-auto mt-6">
        ...
        <p className="text-base md:text-lg text-base-content/70 mb-3">
          {EVENT.dateLabel} | On-site Hackathon | Developer Community
        </p>
        <p className="text-sm md:text-base text-base-content/70 max-w-4xl mx-auto">
          We are prioritizing tool partners and lightweight cash sponsorships for this event. Our
          goal is to get usable tools and credits into participants&apos; hands so they build better
          demos and put your brand in front of the developers using them.
        </p>
      </section>

      <section
        id="tool-partner"
        className="rounded-2xl border border-success/35 bg-base-200 p-6 sm:p-8"
      >
        ...
        <ul className="space-y-2 text-sm sm:text-base text-base-content/80">
          <li>API credits or licenses provided to all participants</li>
      ...
      <section
        ...
        className="rounded-2xl border border-primary/30 bg-base-200 p-6 sm:p-8"
      >
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        ...
        <p className="text-sm text-base-content/70 mt-4">
          Recommended for companies wanting brand visibility and swag distribution without a large
          commitment.
        </p>
      </section>
      ...
      <section
        id="premium-tiers"
        className="rounded-2xl border border-warning/35 bg-base-200 p-4 sm:p-6"
      >
