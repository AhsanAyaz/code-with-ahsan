        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 sm:gap-4">
          {COMMUNITY_STATS.map((stat, index) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="bg-base-200 border border-primary/15 rounded-xl p-4 text-center shadow-[0_0_14px_rgba(143,39,224,0.1)] transition-shadow duration-300 hover:border-primary/35 hover:shadow-[0_0_24px_rgba(143,39,224,0.22)]"
            >
