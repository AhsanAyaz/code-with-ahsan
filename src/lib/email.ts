...
const FROM_EMAIL = process.env.EMAIL_FROM_ADDRESS || 'noreply@codewithahsan.dev'
...
async function sendEmail(
  ...
  if (!mg || !MAILGUN_API_KEY) {
    console.warn('[Email] Mailgun API key not configured, skipping email')
    return false
  }
