...
const SocialIcon = ({ kind, href, size = 24, color = 'text-base-content' }: SocialIconProps) => {
  ...
  return (
    ...
    >
      ...
      <SocialSvg
        ...
        className={`fill-current ${color} hover:text-primary-500 dark:hover:text-primary-400 `}
      />
    </a>
  )
}
