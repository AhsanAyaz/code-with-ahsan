...
[Git](https://git-scm.com/downloads) installed in your system. Then follow the [Firebase Functions getting started](https://firebase.google.com/docs/functions/get-started) to create a project.
